...
Il tema ha subito piu' ondate di rinomina/consolidamento che non sono mai state
completate fino in fondo. La forma canonica dei nomi file e' **kebab-case**, per
regola esplicita gia' presente in [naming-conventions.md](./naming-conventions.md)
("Doc Files - Format: `kebab-case.md`") e
[model-docs-governance.md](./model-docs-governance.md) ("Prefer canonical
`kebab-case` docs filenames"). In pratica pero' in `docs/` root convivono ancora
varianti `UPPERCASE`/`snake_case` dello stesso contenuto (o di un fork quasi
identico), quasi tutte introdotte in blocco il 2026-09-09 (commit radice
...
- [composer-modules-not-themes](./composer-modules-not-themes.md)
...
- [document-root-public-html](./document-root-public-html.md)
...
- [filament-5-nested-resources](./filament-5-nested-resources.md)
- [filament-admin-sub-navigation](./filament-admin-sub-navigation.md)
...
- [folio-pages-structure](./folio-pages-structure.md)
- [frameworks](./frameworks.md)
- [gestionale-panels-vs-themes](./gestionale-panels-vs-themes.md)
- [git-collision-audit-bashscripts](./git-collision-audit-bashscripts.md)
- [git-collisions-bashscripts-audit](./git-collisions-bashscripts-audit.md)
...
- [jpgraph-guide](./jpgraph-guide.md)
...
- [one-migration-themes-boundary](./one-migration-themes-boundary.md)
- [packages-integration](./packages-integration.md)
- [pandoc-guide](./pandoc-guide.md)
...
- [public-path-public-html](./public-path-public-html.md)
- [purpose](./purpose.md)
...
- [_archive/FRAMEWORKS](./_archive/FRAMEWORKS.md)
- [_archive/METODI_DUPLICATI_ANALISI](./_archive/METODI_DUPLICATI_ANALISI.md)
- [_archive/README-en](./_archive/README-en.md)
- [_archive/architecture](./_archive/architecture.md)
- [_archive/conflict-resolution-summary](./_archive/conflict-resolution-summary.md)
- [_archive/conflict_resolution_summary](./_archive/conflict_resolution_summary.md)
- [_archive/duplicate_methods_report](./_archive/duplicate_methods_report.md)
- [_archive/index](./_archive/index.md)
- [_archive/metodi-duplicati-analisi](./_archive/metodi-duplicati-analisi.md)
- [_archive/prd](./_archive/prd.md)
- [_archive/root-md-files/CONFLICT_RESOLUTION_SUMMARY](./_archive/root-md-files/CONFLICT_RESOLUTION_SUMMARY.md)
- [_archive/wiki/commands/INDEX](./_archive/wiki/commands/INDEX.md)
- [_archive/wiki/concepts/INDEX](./_archive/wiki/concepts/INDEX.md)
- [_archive/wiki/memories/INDEX](./_archive/wiki/memories/INDEX.md)
- [_archive/wiki/rules/INDEX](./_archive/wiki/rules/INDEX.md)
- [_archive/wiki/schema](./_archive/wiki/schema.md)
- [_archive/wiki/skills/INDEX](./_archive/wiki/skills/INDEX.md)
...
- [epics/zero-epics-and-stories](./epics/zero-epics-and-stories.md)
...
- [headroom/README](./headroom/README.md)

## Mysql-Remote

- [mysql-remote/README](./mysql-remote/README.md)
